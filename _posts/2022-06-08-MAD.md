---
layout: distill
title: "[그래프]  Measuring and Relieving the Over-smoothing Problem for Graph Neural Networks from the Topological View"
date: '2022-06-08 12:37:28 -0400'
tags: paper-review
categories: 
  - 그래프
use_math: true
...
* Dataset
  * 총 7가지의 dataset, _Cora, CiteSeer, PubMed, Amazon Photo, Amazon Computers, Coauthor CS, Coauthor Physics_를 사용하였다. Dataset의 Statistics는 아래와 같이 요약된다.  
